...
let A = String(prompt("primera palabra: ")).toLowerCase();      //pedimos al usuario que ingrese la primera palabra    
let B = String(prompt("segunda palabra: ")).toLowerCase();      //pedimos al usuario que ingrese la segunda palabra    
let password = "";                                              //variable vacia donde se va a guardar la contraseña

let letras = /^[a-z]+$/;

if (letras.test(A) && letras.test(B)) {
